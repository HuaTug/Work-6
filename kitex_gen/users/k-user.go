...
func (p *LoginUserResponse) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
func (p *LoginUserResponse) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "RefreshToken", thrift.STRING, 4)
...
func (p *LoginUserResponse) fastWriteField5(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "user", thrift.STRUCT, 5)
	offset += p.User.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}
...
func (p *LoginUserResponse) field4Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("RefreshToken", thrift.STRING, 4)
...
func (p *LoginUserResponse) field5Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("user", thrift.STRUCT, 5)
	l += p.User.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}
